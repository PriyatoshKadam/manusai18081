...
export default function HealthPage() {
  ...
  const totalDeliveryAttempts = health.reduce((sum: number, row: any) => sum + Number(row.delivery_attempts || 0), 0);
