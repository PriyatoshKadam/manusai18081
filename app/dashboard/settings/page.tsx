  ...
  return (
    <div className="fade-in max-w-3xl">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="font-display text-lg font-semibold text-ink-950">Websites</h2>
          <p className="text-sm text-ink-500 mt-0.5">Choose which websites GAfix watches and update their tracking details.</p>
        </div>
        <button onClick={() => setShowAdd(!showAdd)} className="bg-btn-dark text-btn-dark-fg px-4 py-2 rounded-full text-sm font-medium hover:bg-btn-dark-hover">
      ...
      {showAdd && (
        ...
        >
          <h3 className="font-display font-semibold text-ink-950 mb-2">Add a website</h3>
