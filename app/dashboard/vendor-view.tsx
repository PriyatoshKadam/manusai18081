...
import PlatformGovernanceEnhancer from './platform-governance-enhancer';
import PlatformEvidenceSemanticsEnhancer from './platform-evidence-semantics-enhancer';

export default function VendorViewWithReferenceMonitoring(props: { vendor: string; label: string; id: string | null }) {
  return <><VendorView {...props} /><ReferenceMonitoringPanels vendor={props.vendor} /><PlatformGovernanceEnhancer vendor={props.vendor} /><EventIssueTimestampEnhancer vendor={props.vendor} /><ParameterGovernanceTableEnhancer vendor={props.vendor} /><PageGovernanceTableEnhancer vendor={props.vendor} /><ConsentGovernanceEnhancer vendor={props.vendor} /><PlatformEvidenceSemanticsEnhancer vendor={props.vendor} /></>;
}
