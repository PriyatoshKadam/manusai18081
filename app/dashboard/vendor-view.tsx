...
export default function VendorViewWithReferenceMonitoring(props: { vendor: string; label: string; id: string | null }) {
  return <><VendorView {...props} /><ReferenceMonitoringPanels vendor={props.vendor} /><EventIssueTimestampEnhancer vendor={props.vendor} /><ParameterGovernanceTableEnhancer vendor={props.vendor} /><PageGovernanceTableEnhancer vendor={props.vendor} /></>;
}
